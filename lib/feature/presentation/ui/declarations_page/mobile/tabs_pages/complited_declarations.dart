...
class ComplitedDeclarations extends StatelessWidget {
  const ComplitedDeclarations({
    Key? key,
  }) : super(key: key);
        ...
        if (state is DeclarationsLoadedState) {
          return Padding(
            ...
            child: DeclarationsList(
              items: state.doneDeclarations,
              onTap: (i) => context.pushNamed(NavigationRouteNames.declarationInfo),
            ),
          );
        }
