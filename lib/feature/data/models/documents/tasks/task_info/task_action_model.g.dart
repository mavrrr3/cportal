...
part of 'task_action_model.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class TaskActionModelAdapter extends TypeAdapter<TaskActionModel> {
  @override
  final int typeId = 25;

  @override
  TaskActionModel read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, TaskActionModel obj) {
    writer
      ..writeByte(9)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is TaskActionModelAdapter &&
