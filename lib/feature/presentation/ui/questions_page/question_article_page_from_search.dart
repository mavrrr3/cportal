...
class QuestionArticlePageFromSearch extends StatelessWidget {
  final String id;
  const QuestionArticlePageFromSearch({Key? key, required this.id})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Swipe(
        ...
        child: BlocBuilder<GetSingleQuestionBloc, GetSingleQuestionState>(
          builder: (context, state) {
            if (state is GetSingleQuestionLoadedState) {
              final ArticleEntity singleArticle = state.singleQuestion;
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsets.symmetric(
                                      horizontal: isLargerThenTablet(context)
                                          ? 32
                                          : 20.0,
                                    ),
