...
class LogInWithPinCodeUseCase
    extends IUseCase<UserEntity?, LoginWitPinCodeParams> {
  ...
  Future<Either<Failure, UserEntity?>> call(
      LoginWitPinCodeParams params) async {
    final pinIsMatched =
        await _pinCodeRepository.pinIsMatched(pinCode: params.pinCode);
