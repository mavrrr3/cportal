...
class UserTypeModelAdapter extends TypeAdapter<UserTypeModel> {
  @override
  final int typeId = 1;

  @override
  UserTypeModel read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
  ...
  @override
  void write(BinaryWriter writer, UserTypeModel obj) {
    writer
      ..writeByte(3)
      ..writeByte(0)
      ..write(obj.id)
