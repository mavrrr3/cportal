...
class ConnectingDevicesLocalDataSource implements IConnectingDevicesLocalDataSource {
  ...
  Future<ConnectingDevicesModel?> getConnectingDevices() async {
    final box = await _hive.openBox<ConnectingDevicesModel>('connecting_devices');

    return box.get('connecting_devices');
  }

  @override
  Future<void> saveConnectingDevices(ConnectingDevicesModel connectingDevices) async {
    final box = await _hive.openBox<ConnectingDevicesModel>('connecting_devices');
